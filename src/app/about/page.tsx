    ...
    <div className="max-w-2xl w-full">
      <div className="w-full">
        <div className="min-h-screen">
          ...
          <div className="font-bold pt-10 pb-3 text-mypink text-lg">
            Ivan Lin
          </div>
          <p className="text-mygray text-sm">software engineer</p>

          <p className="pt-10">
            i&apos;m currently a software engineering
            major at rochester institute of technology. i have a passion for coding, learning,
            and building.
          </p>

          <p className="pt-10">
            when i&apos;m not programming you can catch exploring coffee shops,
            trying new restaurants, sipping matcha while watching anime.
          </p>
          ...
          <p className="pt-10">
            ...
            <span className="font-bold">
              <a href="mailto:you@example.com">connect with me here.</a>
            </span>
          </p>
          ...
          <ul className="pt-10 flex flex-row gap-5 pb-6">
            <li>
              <a
                href="https://github.com/ilin0418"
                target="_blank"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="hover:text-mypink transition-colors"
                >
            ...
            <li>
              <a
                href="https://linkedin.com/in/ilin0418"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
              >
